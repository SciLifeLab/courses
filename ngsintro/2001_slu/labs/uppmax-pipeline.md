...
$ cp -r /sw/share/compstore/courses/ngsintro/uppmax_pipeline_exercise/data /proj/g2020005/nobackup/<username>/uppmax_pipeline_exercise
```

Have a look in `/proj/g2020005/nobackup/<username>/uppmax_pipeline_exercise`:

```bash
$ cd /proj/g2020005/nobackup/<username>/uppmax_pipeline_exercise
...
```bash
$ cd /proj/g2020005/nobackup/<username>/uppmax_pipeline_exercise/exomeSeq
```
