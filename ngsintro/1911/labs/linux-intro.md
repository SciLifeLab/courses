...
```
$ salloc -A g2019020 -t 07:00:00 -p core -n 1 --no-shell --reservation=g2019020_25 &
```
...
The absolute path to the course's nobackup folder would be **/proj/g2019020/nobackup**
...
```
$ mkdir /proj/g2019020/nobackup/<username>
$ mkdir /proj/g2019020/nobackup/<username>/linux_tutorial
```

or

```
$ mkdir -p /proj/g2019020/nobackup/<username>/linux_tutorial
```
...
$ cp -r /sw/share/compstore/courses/ngsintro/linux_tutorial/* /proj/g2019020/nobackup/<username>/linux_tutorial
```
...
$ wget -P /proj/g2019020/nobackup/<username>/linux_tutorial/ {{site.url}}/ngsintro/common/files/files.tar.gz
```
...
```
$ cd /proj/g2019020/nobackup/<username>/linux_tutorial
...
If you look at the memory usage at the same time, and see that it's maxed out (used 100% of total), you can more or less abort the analysis.
